...
public class EasyPlayer extends Player implements PlayerStrategy {
    ...
    private ArrayList<Move> getPossibleMoves(Board board) {
        ...
        for (int i = 0; i < Board.DIMENSION; i++) {
            for (int j = 0; j < Board.DIMENSION; j++) {
                if (getPlayerType() == Checkers.BLUE &&
                        (board.getPosition(i, j).equals(Board.BLUE_PIECE_KING)
                        || board.getPosition(i, j).equals(Board.BLUE_PIECE_NORMAL))) {
    ...
    private boolean canBeJumped(Board board, Move move) {
        ...
        if (getPlayerType() == Checkers.RED && nwPosition.equals(Board.BLUE_PIECE_KING)) {
            return true;
        }
        if (getPlayerType() == Checkers.BLUE && (nwPosition.equals(Board.RED_PIECE_NORMAL)
                || nwPosition.equals(Board.RED_PIECE_KING))) {
            return true;
        }
        if (getPlayerType() == Checkers.RED && nePosition.equals(Board.BLUE_PIECE_KING)) {
            return true;
        }
        if (getPlayerType() == Checkers.BLUE && (nePosition.equals(Board.RED_PIECE_NORMAL)
                || nePosition.equals(Board.RED_PIECE_KING))) {
            return true;
        }
        if (getPlayerType() == Checkers.RED && (swPosition.equals(Board.BLUE_PIECE_KING)
                || swPosition.equals(Board.BLUE_PIECE_NORMAL))) {
            return true;
        }
        if (getPlayerType() == Checkers.BLUE && swPosition.equals(Board.RED_PIECE_KING)) {
            return true;
        }
        if (getPlayerType() == Checkers.RED && (sePosition.equals(Board.BLUE_PIECE_KING)
                || sePosition.equals(Board.BLUE_PIECE_NORMAL))) {
            return true;
        }
        if (getPlayerType() == Checkers.BLUE && sePosition.equals(Board.RED_PIECE_KING)) {
            return true;
        }
    ...
    private boolean isInterferingMove(Board board, Move move, int direction) {
        ...
        if (direction == NORTH_EAST || direction == NORTH_WEST) {
            if (currentPosition.equals(Board.RED_PIECE_KING)
                    && (board.getPosition(x + 1, y - 1).equals(Board.BLUE_PIECE_NORMAL)
                    || board.getPosition(x + 1, y - 1).equals(Board.BLUE_PIECE_KING))) {
                return true;
            }
            if (currentPosition.equals(Board.BLUE_PIECE_NORMAL) || currentPosition.equals(Board.BLUE_PIECE_KING)
            ...
            if (currentPosition.equals(Board.BLUE_PIECE_KING)
                    && (board.getPosition(x - 1, y - 1).equals(Board.RED_PIECE_KING)
                    || board.getPosition(x - 1, y - 1).equals(Board.RED_PIECE_NORMAL))) {
                return true;
            }
    ...
    private Move buildMove(Board board, int sourceX, int sourceY, int direction) {
        ...
        if (piece.equals(Board.RED_PIECE_KING)) {
            if (board.getPosition(sourceX + changeX, sourceY + changeY).equals(Board.BLUE_PIECE_KING)
                    || board.getPosition(sourceX + changeX, sourceY + changeY).equals(Board.BLUE_PIECE_NORMAL)) {
        ...
        else if (piece.equals(Board.BLUE_PIECE_NORMAL) || piece.equals(Board.BLUE_PIECE_KING)) {
